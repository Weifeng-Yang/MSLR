%  Functions for computing gradients and licpchitz constants for IBPG

function [grad,tao,bobj,sgrads]=IBPGcompute(var,w,wz,num,n,batch_size,b,y,index,sgrads,flag)
    if(flag==1)
    tao=0;
    grad=0;
    bobj=0;
