...
if(flag==1)
[ws,bs,losscor,loss,losstest,tr,bts,~,auc]=GIST(var,testvar,y,ytest,b,w,maxiteropt,lamda,aa,stopindex,r);
...
elseif(flag==2)
[ws,bs,losscor,loss,losstest,tr,~,auc]=GPGN(var,testvar,y,ytest,w,b,maxiteropt,num,lamda,aa,stopindex,r);
lossdata{1}=loss;
testloss{1}=losstest;
trdata{1}=tr;
losscors{1}=losscor;
...
elseif(flag==3)
[ws,bs,losscor,loss,losstest,tr,bts,~,auc]=BPGD(var,testvar,y,ytest,b,w,maxiteropt,num,lamda,aa,stopindex,r);
lossdata{1}=loss;
testloss{1}=losstest;
trdata{1}=tr;
losscors{1}=losscor;
...
elseif(flag==4)
[ws,bs,losscor,loss,losstest,tr,bts,ats,~,auc]=IBPG(var,testvar,y,ytest,b,w,maxiteropt,num,lamda,aa,stopindex,r);
lossdata{1}=loss;
testloss{1}=losstest;
trdata{1}=tr;
losscors{1}=losscor;
...
elseif(flag==5)
[ws,bs,losscor,loss,losstest,tr,bts,~,auc]=BPL(var,testvar,y,ytest,b,w,maxiteropt,num,lamda,aa,stopindex,r);
lossdata{1}=loss;
testloss{1}=losstest;
trdata{1}=tr;
losscors{1}=losscor;
