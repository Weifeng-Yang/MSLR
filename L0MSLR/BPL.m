...
function [w,b,losscor,loss,losstest,timerun,bts,rate,auc]=BPL(var,testvar,y,ytest,b,w,maxiteropt,num,lamda,aa,stopindex,r)
...
[w,b,gradcheck,L]=BPLparaupdate(var,wv,z,num,bsize,bv,y,index,aa,lamda,r);
[loss(i+1),~]=losscompute(var,w,num,b,y,bsize,lamda,1);

%% Judging whether to extrapolate
if(loss(i+1)>loss(i))
    [w,b,gradcheck,L]=BPLparaupdate(var,wk,z,num,bsize,bk,y,index,aa,lamda,r);
end
