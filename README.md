...
## Data
This code has built-in the data "Concrete Crack Images[<sup>3</sup>](#refer-id)" mentioned in paper[<sup>1</sup>](#refer-id). For the other dataset: (1)GochiUsa-Faces[<sup>4</sup>](#refer-id) (2) Br35H :: Brain Tumor Detection[<sup>5</sup>](#refer-id), the part extracted from this paper[<sup>1</sup>](#refer-id) has been put into the following network disk address: 
